(function(window, angular){
  ...
  mfb.directive('mfbMenuCustom', ['$timeout', 'EventFactory' ,'EVENT_TYPES',function($timeout, EventFactory, eventTypes){
    return {
      restrict: 'EA',
      transclude: true,
      replace: true,
      ...
      link: function(scope, elem, attrs) {
        if(scope.type === eventTypes.EVENT_IMAGE) {
            delete scope.label;
        }
        var openState = 'open',
            closedState = 'closed';
  ...
  mfb.directive('mfbButtonCustom', [function(){
    return {
      require: '^mfbMenu',
      restrict: 'EA',
      transclude: true,
