(function() {
    ...
    SurveillanceController.$inject = ["$scope", "$stateParams", "PanesFactory", "LISTENER_NAMES", "$window", "$timeout", "ApiFactory", "TYPE_MESSAGES", "SocketService", "SettingFactory"];

    function SurveillanceController($scope, $stateParams, PanesFactory, listenerNames, $window, $timeout, ApiFactory, typeMessages, SocketService, SettingFactory) {
